        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-7xl mx-auto">
          ...
          >
            <div className="relative h-full w-full rounded-2xl overflow-hidden">
              ...
              />
              {/* Overlay gradiente sutil para integrar com o fundo */}
              <div className="absolute inset-0 bg-gradient-to-l from-transparent via-transparent to-[#0A0A0A]/40"></div>
            </div>
          </motion.div>
        </div>
      </div>
